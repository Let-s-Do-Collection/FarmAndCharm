...
public class SupplyCartItem extends AbstractCartItem {
    ...
    @Override
    protected net.minecraft.world.entity.Entity createCartEntity(Level level) {
    ...
    public void appendHoverText(ItemStack stack, Item.TooltipContext context, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
        ...
        if (Screen.hasShiftDown()) {
            tooltipComponents.add(Component.translatable("tooltip.farm_and_charm.supply_cart.info_0")
